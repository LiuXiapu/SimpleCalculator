...
import com.sae.sc.R;
import com.sae.sc.view.StringScrollPicker;
import com.sae.sc.view.base.ScrollPickerView;
...
public class CalendarSelector {
    ...
    private void initPicker() {
        ...
        mMap = CalendarUtil.parseAverageYear(1901 + mYearPosition + "年");
        setMonthList();
        ...
        mYearPicker.setOnSelectedListener(new ScrollPickerView.OnSelectedListener() {
            ...
            public void onSelected(ScrollPickerView scrollPickerView, int position) {
                ...
                if (isLunar) {
                    mMap = CalendarUtil.parseLunarYear(mSelectedYear);
                } else {
                    mMap = CalendarUtil.parseAverageYear(mSelectedYear);
                }
                setMonthList();
            }
        });
    ...
    private void setMonthList() {
        ...
        //mTransformedMonth = mMonthPicker.getSelectedItem();
        setDayList();
    }
    ...
    private void setDayList() {
        ...
        //mTransformedDay = mDayPicker.getSelectedItem();
    }
    ...
    private void initPopup(View v) {
        ...
        mPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                CalendarUtil.backgroundAlpha(mContext, 1f);
            }
        });
    }
    ...
    private void initListener() {
        ...
        tvLunar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mMap = CalendarUtil.average2Lunar(mYearPicker.getSelectedItem(),
                ...
                //mTransformedYear = mYearPicker.getSelectedItem();
        ...
        tvAverage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                HashMap<String, Object> map = CalendarUtil.lunar2Average(mYearPicker.getSelectedItem(),
                        mMonthPosition, mDayPosition);
                ...
                tvLunar.setBackground(ContextCompat.getDrawable(mContext, R.drawable
                        .bg_lunar_calendar));
                mMap = CalendarUtil.parseAverageYear(mYearPicker.getSelectedItem());
                setMonthList();
                setDayList();
            }
        });
    ...
    public void show(View v) {
        CalendarUtil.hideSoftInput(mContext);
        CalendarUtil.backgroundAlpha(mContext, 0.5f);
